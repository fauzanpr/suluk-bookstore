        ...
        <div class="container">
            ...
            <div class="flex-w flex-sb-m p-b-52">
                <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    ...
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".filsafat">
                        Filsafat
                    </button>

                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".komputer">
                        Komputer
                    </button>

                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".cerita">
                        cerita
                    </button>
                </div>
            ...
            <div class="row isotope-grid">
                ...
                @foreach ($book as $b)
                    <!-- Book card -->
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{ $b->category->category_name }}">
                        <!-- Block2 -->
                        <div class="block2">
